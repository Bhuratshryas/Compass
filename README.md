...
**We do not collect your data.** Compass - Local AI does **not** collect, store, or transmit any of your personal data to our servers or any third party.
...
- **Images & OCR:** When you attach an image, Compass - Local AI uses Apple’s on-device Vision/OCR APIs to read text from the image. The image and extracted text stay on your device and are not uploaded to us or any third party.
...
1. Open the `Compass.xcodeproj` in Xcode (app name: Compass - Local AI).
